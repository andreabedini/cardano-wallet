    ...
    in
      lib.recursiveUpdate
        (removeAttrs outputsSystems [ "systemHydraJobs" "systemHydraJobsPr" "systemHydraJobsBors" ])
        {
          ...
          hydraJobs = mkHydraJobs outputsSystems.systemHydraJobs;
          hydraJobsPr = mkHydraJobs outputsSystems.systemHydraJobsPr;
          hydraJobsBors = mkHydraJobs outputsSystems.systemHydraJobsBors;
        }
    ;
}
